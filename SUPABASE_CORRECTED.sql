-- ============================================================================
-- ECOCYCLE SUPABASE - ADMIN FIXES & RLS POLICIES (CORRECTED)
-- Paste this entire script into Supabase SQL Editor
-- ERROR FIX: INSERT policies only allow WITH CHECK, not USING
-- ============================================================================
